...
"""
PV + battery capacity optimization only (no PCM TES sizing).

Heat pump capacity is fixed from Input_Parameters; PCM heating and cooling
capacities are fixed at zero. Only PVSize and BatterySize are decision variables.
"""
def Cap_Baseline_PVB(input_df, lossofloadcost, capacity_costs, scenario):
    ...
    # Capacities: size PV and battery; HP fixed from Input_Parameters; PCM fixed at 0
